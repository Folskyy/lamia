...
previsores = pd.read_csv('/home/gabriel/Documentos/lamia/binary_classification/entradas_breast.csv')
classe = pd.read_csv('/home/gabriel/Documentos/lamia/binary_classification/saidas_breast.csv')
...
# optimizer: Função para fazer o ajuste dos pesos Ex: SGD, adam, RMSprop...
